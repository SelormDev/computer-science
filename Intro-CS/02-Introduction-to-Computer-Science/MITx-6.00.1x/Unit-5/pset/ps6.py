...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in string.ascii_lowercase:
            shifted_dictionary[letter] = string.ascii_lowercase[(string.ascii_lowercase.index(letter) + shift) % 26]
        for letter in string.ascii_uppercase:
            shifted_dictionary[letter] = string.ascii_uppercase[(string.ascii_uppercase.index(letter) + shift) % 26]
    ...
    def apply_shift(self, shift):
        ...
        for letter in self.message_text:
            if letter in shifted_dictionary:
                shifted_message += shifted_dictionary[letter]
            else:
